...
num_filt = 16
# model, pad, learning_rate, batch_size = md.ln_model(input_shape=(size_t, size_x, n_c), filter_shape=(21, 5), num_filter=2)
model, pad, learning_rate, batch_size = md.ln_model_deep(input_shape=(size_t, size_x, n_c), filter_shape=((21, 5), (21, 5)), num_filter=(4, 4))
# model, pad, learning_rate = md.hrc_model(input_shape=(size_t, size_x, n_c), filter_shape=(21, size_x), num_filter=num_filter)
